...
class EntityTest {
    ...
    void itemMethods() {
        ...
        assertThrowsExactly(IllegalArgumentException.class, () -> humanEntityTest.useItem(battleRifle));
        assertThrowsExactly(IllegalArgumentException.class, () -> humanEntityTest.useItem(mjolnirArmor));
        assertThrowsExactly(IllegalArgumentException.class, () -> humanEntityTest.useItem(new Item("test", "this is a test", "Item", 1) {
        }));
        assertThrowsExactly(IllegalArgumentException.class, () -> humanEntityTest.useItem(null));
        assertDoesNotThrow(() -> humanEntityTest.useItem(humanMRE));
    }
